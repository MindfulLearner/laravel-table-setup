            ...
            <div class="flex justify-between items-center mt-8">
                ...
                <div class="flex flex-col items-end gap-2">
                    ...
                    <button type="button" onclick="proceedToPayment()" id="proceedButton" disabled
                        class="px-8 py-4 bg-gradient-to-t from-gray-600 to-gray-800 text-white rounded-full shadow-lg hover:bg-gray-500 focus:outline-none focus:ring-4 focus:ring-gray-400 transition-all ease-in-out duration-300 transform hover:scale-105 h-14 opacity-50">
