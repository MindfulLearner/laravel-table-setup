...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="max-w-4xl mx-auto bg-gradient-to-r from-yellow-600 to-yellow-800 p-6 rounded-lg shadow-md">
        ...
        <form id="payment-form" action="{{ route('updateSponsorBronze') }}" method="POST">
            @csrf
            ...
            <button type="button" id="submit-button" class="mt-4 px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-500">Attiva Piano Bronze</button>
        </form>
    </div>
