        ...
        <div class="bg-gradient-to-r from-neutral-900 via-neutral-800 to-neutral-900 p-8 rounded-xl shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="flex items-center">
                    <input id="remember_me" type="checkbox" class="h-4 w-4 text-black border focus:focus:ring-transparent dark:focus:ring-transparent border-gray-500 rounded" name="remember">
